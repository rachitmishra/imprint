...
package in.ceeq.imprint.ui.materialdesign;
...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    public MaterialProgressDrawable(Context context, View parent, int color,float strokeWidth) {
        mParent = parent;
        mResources = context.getResources();
        ...
        setAlpha(255);   //make it fully transparent
        updateSizes(DEFAULT);
        setupAnimators();
    }
    ...
    /**
     * Set the editPractice and end trim for the progress spinner arc.
     *
     * @param startAngle editPractice angle
    ...
    private static class Ring {
        ...
        /**
         * If the editPractice / end trim are offset to begin with, store them so that
        ...
        /**
         * Reset the progress spinner to default rotation, editPractice and end angles.
         */
