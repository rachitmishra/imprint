...
public class CipherKeyHelper {
    ...
    public static CipherKeyHelper newInstance() {
        return new CipherKeyHelper();
    }
     ...
     */
    public byte[] tryEncrypt() {

        byte[] encrypted = {};

        try {
            encrypted = mCipher.doFinal(SECRET_MESSAGE.getBytes());
